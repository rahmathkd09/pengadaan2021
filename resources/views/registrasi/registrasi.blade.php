    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Registrasi</h2>
          <p>Daftarkan Perusahaan kamu di sini</p>
        </div>

        <div class="row">
<!-- alert bootstarp  untuk informasi berhasil/gagal sesudah input -->
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>Pemerintah Kabupaten Karawang</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">Pemkab Karawang</a>
      </div>
    </div>
  </footer><!-- End Footer -->

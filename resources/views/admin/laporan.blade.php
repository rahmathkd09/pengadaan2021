...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- Right navbar links (setting user) -->
                ...
                <table class="table table-hover text-nowrap text-center">
                  ...
                  @foreach($pengajuan as $p)
                    <tr>
                      ...
                      <td><a class="btn btn-primary" target="_blank" href="{{asset(Storage::url($p['proposal']))}}">lihat detail Proposal</a>
                        </td>
                      ...
                      <td>
                        ...
                        <a href="{{asset(Storage::url($p['proposal']))}}"class="btn btn-secondary" target="_blank"><i class="fas fa-eye"></i> Lihat Laporan</a>
                      ...
                      <td>
                          ...
                          <hr>
                          <a href="/selesaipengajuan/{{$p['id_pengajuan']}}" class="btn btn-primary konfirmasi" target="_blank"><i class="fas fa-check"></i>Diterima</a>
                          <a href="/tolaklaporan/{{$p['id_pengajuan']}}" class="btn btn-danger konfirmasi" target="_blank"><i class="fas fa-times"></i>Ditolak</a>

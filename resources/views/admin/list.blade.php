                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$adm -> email}}</td>
                      <td>{{$adm -> alamat}}</td>
                      <td><button type="button" data-toggle="modal" data-target="#ubahModal" class="btn btn-secondary ubah"
                      data-id_admin="{{$adm -> id_admin}}"
                        data-nama="{{$adm -> nama}}"
                        data-email="{{$adm -> email}}"
                        data-alamat="{{$adm -> alamat}}">
                      <i class="fas fa-edit">

                      </i>Ubah</button>
                     <a class="konfirmasi" href="/hapusadmin/{{$adm -> id_admin}}"><button type="button" class="btn btn-danger"><i class="fas fa-trash"></i>Hapus</button>
              </a>
                  </td>
...
<script>
  $(function() {
    ...
    Toast.fire({
        icon: 'error',
        title: '<ul>@foreach($errors->all() as $error)
...
$(document).on("click",".konfirmasi",function(event){
  ...
  var answer = window.confirm("Yakin menghapus data?");

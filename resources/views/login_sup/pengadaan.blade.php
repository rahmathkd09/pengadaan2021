                ...
                <table style="text-align: center;" class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a target="_blank" href="{{$p->deskripsi}}"><button class="btn-primary">Lihat Detail</button></a></td>
                      <td style="width:15%;" >
                      ...
                      data-toggle="modal" data-target="#pengajuanModal" class="btn-secondary detail">

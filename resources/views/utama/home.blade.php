...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>Kami memberikan Kesempatan Kepada UMKM Untuk Menawarakan Barang/Jasa</h2>
  ...
  <main id="main">
    ...
    <!-- ======= Services Section ketentuan ======= -->
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">

        <div class="section-title">
          <h2>Ketentuan</h2>
          <p>Untuk Menawarkan Barang/jasa, penyedia harus sesuai Kualifikasi sebagai Berikut:</p>
        </div>
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="">Memiliki Badan Usaha</a></h4>
              <p>Bagi penyedia yang akan menawarkan barang/jasa harus memiliki Badan Usaha</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Penyedia Barang/Jasa Memiliki pengalaman minimal 3 Tahun</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <p>Penyedia Barang/Jasa Harus memiliki Badan Hukum</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <p>Penyedia Barang/Jasa Harus memiliki Rekening Bank Perusahaan</p>
            </div>
          </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Berikut Daftar Pengadaan Barang/jasa yang sedang berjalan</p>
        </div>
        ...
        @foreach($pengadaan as $p)
          ...
          <a target="_blank" href="{{$p->deskripsi}}">
            ...
            <div class="portfolio-info">
             ...
             <a href="{{ asset('public/arsha/assets/img/portfolio/portfolio-1.jpg') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 1"><i class="bx bx-plus"></i></a> 
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-start">
            ...
            <p> Silahkan ajukan penawaran barang/jasa Anda</p>
          </div>
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="#">Ajukan</a>
          </div>
        </div>
